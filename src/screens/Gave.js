...
const Gave = ({navigation}) => {
    return (
        ...
        <View style={{  display: 'flex', flexDirection: 'row',marginHorizontal:10 }}>
            ...
            <Text onPress={() => navigation.navigate('Expense')} style={{ fontSize: 30, color: 'black',marginLeft:3,flex:1 ,flex:1,textAlign:'center'}}>{"<"}</Text>
    
            <Text style={{ fontSize: 20, color: '#DE3B40', fontWeight: 'bold', marginVertical: 'auto',flex:7,textAlign:'center' }}>You Got to $0 Jumma collection</Text>
    
            <Text style={{ fontSize: 30, color: 'black', fontWeight: 'bold',textAlign:'center',flex:1 ,lineHeight:33}}>...</Text>
